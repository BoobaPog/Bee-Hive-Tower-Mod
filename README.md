<a href="https://github.com/BoobaPog/Bee-Hive-Tower-Mod/v0.1.0/BeeHiveTower.dll">
...
Cash per pop: $0.5, Swarm size: +8 (Total 24), Range: +20% (Pop realy means every attack on a bloon, so this path will benifit from having the 02x crosspath)
